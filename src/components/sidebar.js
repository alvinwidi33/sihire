...
const token = window.localStorage.getItem('token')
  ...
  >
    On Boarding
      ...
      <button onClick={handleLogout} className="ml-10" style={{width:"90px",padding: "8px",fontSize: "16px",fontFamily: 'Inter, sans-serif',color: "#fff",borderRadius: "6px",cursor: "pointer",border: "2px solid #2A3E4B",background:"#2A3E4B"}}>
        Log Out
      </button>
      </div>
    </React.Fragment>
