                ...
                <React.Fragment key={interview.id}>
                    ...
                    <div className="detail-interview-ga">
                        <div className="rectangle-style" style={rectangleStyle}>
                            <p style={{ marginTop: '40px', marginLeft: '5%', fontWeight: 'bold', fontSize: '32px', color: '#2A3E4B', position: 'absolute' }}>{interview.job_application_id.applicant.user.name} - {interview.job_application_id.job.job_name}</p>
                            ...
                            <p style={{ marginTop: '200px', marginLeft: '5%', fontWeight: 'bold', fontSize: '24px', color: '#2A3E4B', position: 'absolute' }}>Jadwal Interview</p>
                            <p style={{ marginTop: '240px', marginLeft: '5%', fontSize: '16px', color: '#2A3E4B', position: 'absolute' }}>
                                Hari/Tanggal : {interview.datetime_start && formatDateTime(interview.datetime_start)}
                            </p>
