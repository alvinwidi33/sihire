            ...
            <tbody>
              {onboarding.map((onboarding) => (
                <tr
                  ...
                  style={{
                    backgroundColor:
                      onboarding.job_application_id.status === "Withdrawn"
                        ? "#FFC0CB"
                        : isDatePassed(onboarding.datetime_end)
                        ? "#D3D3D3"
                        : onboarding.job_application_id.status === "On Boarding"
                        ? "#FFFFFF"
                        : "#D3D3D3",
                  }}
                >
                  ...
                  >
                    {onboarding.job_application_id.applicant.user.name}
                  </td>
                  <td
                    style={{
                      border: "2px solid #2A3E4B",
