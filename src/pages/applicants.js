...
function Applicants() {
    ...
    const getJobApplication = async () => {
        await fetch(`https://sihire-be.vercel.app/api/job-application/get?status=${selectedStatus}&posisi=${selectedPosisi}`)
            .then(resp => resp.json())
            .then(data => {
                ...
                <div className='w-full text-center'>
                    <div className='py-5 rounded rounded-xl border border-2 border-black'>
                        ...
                        <div className='flex justify-around mt-5'>
                            <div flex-center>
                                <p>Status</p>
                                <select value={selectedStatus} onChange={handleStatusChange} id="cars" name="cars" className="px-20 py-2 border border-black rounded rounded-lg">
                            ...
                            <div>
                                <p>Posisi</p>
                                <select value={selectedPosisi} onChange={handlePosisiChange} id="posisi" name="posisi" className="px-20 py-2 border border-black rounded rounded-lg">
