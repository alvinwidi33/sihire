      ...
      <div className="job-posting" style={{ position: "relative" }}>
        ...
        <Link to="/add-job-posting">
          <button style={{ width: "180px", padding: "8px", fontSize: "16px", fontFamily: 'Inter, sans-serif', fontWeight: 'bold', color: "#fff", background: "#2A3E4B",
            ...
            marginTop: "-52px", marginBottom: "12px", marginLeft: "88%", position: "absolute", border: "2px solid #2A3E4B", }}>
            Tambah Pekerjaan
          </button>
        </Link>
        {jobs && (
          <table style={{ marginLeft: "22%", borderCollapse: "collapse", width: "80%" }}>
            <thead>
              <tr>
                ...
                <th style={{ border: "2px solid #2A3E4B", padding: "8px", textAlign: "left", fontWeight: "bold" }}>Tutup</th>
